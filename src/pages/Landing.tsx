        ...
        >
          <motion.div variants={heroTextVariant} className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-lg text-slate-700 mb-6 max-w-lg">
              Grupo de Investigación en Sistemas Inteligentes y Ciberfísicos (GISICF) — Universidad Estatal del Sur de
              Manabí. Plataforma para registrar, gestionar y mostrar la producción científica y proyectos de
              vinculación.
            </p>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <div className="text-center md:text-left">
                <p className="text-sm opacity-90">
                  © 2026 UNESUM - Grupo GISICF. Todos los derechos reservados. Hecho por Madelin Chancay Baque
                </p>
